...
/// </summary>
public class DepositTransactionHandler : BaseTransactionTypeHandler
{
    /// <inheritdoc />
    public override string TransactionType => nameof(TransactionActionTypes.DEPOSIT);
    ...
    {
        return !string.IsNullOrEmpty(item.Description) ? item.Description : $"Deposit amount {item.Amount}";
    }
}
