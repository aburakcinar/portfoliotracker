...
/// <summary>
/// Handler for dividend distribution transactions
/// </summary>
public class DividendDistributionTransactionHandler : BaseTransactionTypeHandler
{
    /// <inheritdoc />
    public override string TransactionType => nameof(TransactionActionTypes.DIVIDEND_DISTRIBUTION);
    ...
    {
        return !string.IsNullOrEmpty(item.Description) ? item.Description : $"Dividend amount {item.Amount}";
    }
}
