...
/// <summary>
/// Handler for interest transactions
/// </summary>
public class InterestTransactionHandler : BaseTransactionTypeHandler
{
    /// <inheritdoc />
    public override string TransactionType => nameof(TransactionActionTypes.INTEREST);
    ...
    {
        return !string.IsNullOrEmpty(item.Description) ? item.Description : $"Interest amount {item.Amount}";
    }
}
