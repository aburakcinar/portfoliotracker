...
/// <summary>
/// Handler for sell asset transactions
/// </summary>
public class SellAssetTransactionHandler : BaseTransactionTypeHandler
{
    /// <inheritdoc />
    public override string TransactionType => nameof(TransactionActionTypes.SELL_ASSET);
    ...
    {
        return !string.IsNullOrEmpty(item.Description) ? item.Description : $"Sell asset amount {item.Amount}";
    }
